...
#SimMatECFP6_lanapdb_sorted = np.sort(ECFP(lanapdb, 3))
#SimMatECFP6_coconut_sorted = np.sort(ECFP(coconut, 3))
#SimMatECFP6_ChemDiv_sorted = np.sort(ECFP(ChemDiv, 3))
SimMatECFP6_Maybridge_sorted = np.sort(ECFP(Maybridge, 3))
#SimMatECFP6_LifeChemicals_sorted = np.sort(ECFP(LifeChemicals, 3))
