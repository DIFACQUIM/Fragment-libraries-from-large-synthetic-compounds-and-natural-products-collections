...
x1.plot(SimMatECFP6_EnamineSolWat_RO3_sorted, proportionECFP_EnamineSolWat_RO3, label="EnamineColl_RO3", c="black")
x1.plot(SimMatECFP6_lanapdb_RO3_sorted, proportionECFP_lanapdb_RO3, label="LANaPDB_RO3", c="green")
x1.plot(SimMatECFP6_coconut_RO3_sorted, proportionECFP_coconut_RO3, label="COCONUT_RO3", c="cyan")
SimMatECFP6_coconut_RO3_sorted=0
proportionECFP_coconut_RO3=0
x1.plot(SimMatECFP6_ChemDiv_RO3_sorted, proportionECFP_ChemDiv_RO3, label="ChemDiv_RO3", c="blue")
x1.plot(SimMatECFP6_Maybridge_RO3_sorted, proportionECFP_Maybridge_RO3, label="Maybridge_RO3", c="purple")
x1.plot(SimMatECFP6_LifeChemicals_RO3_sorted, proportionECFP_LifeChemicals_RO3, label="LifeChemicals_RO3", c="red")
x1.plot(SimMatECFP6_CRAFT_RO3_sorted, proportionECFP_CRAFT_RO3, label="CRAFT_RO3", c="yellow")
x1.grid(alpha=0.5)
x1.set_xlabel('$Similarity$', fontsize=14)
x1.set_ylabel('$Fraction$', fontsize=14)
x1.set_title('Morgan3', fontsize=18)
#fig1.legend()
...
fig.savefig("CDF_fragments_morgan3.png", dpi=400)
